import HeroPng from "../assets/images/bit.png"
export const Hero = () => (
  <section class="text-gray-600 body-font hero-section">
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
      <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 header-hero-h1">
          Let us help fundraise for that project at{" "}
          <span class="hidden lg:inline-block text-5xl text-upper " >
            Koin Funds
          </span >
        </h1>
