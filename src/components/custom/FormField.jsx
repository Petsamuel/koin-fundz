...
export const ImageField = ({ src, handleChange, alt }) => {
  return (
    <>
      {
        <>
      ...
      {isTextArea ? (
        <div className="mt-2">
          <textarea
            ...
            name="about"
            rows="5"
            className="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:py-1.5 sm:text-sm sm:leading-6 p-4 outline-none bg-text-[14px]"
          ></textarea>
